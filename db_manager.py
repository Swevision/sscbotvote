...
VOTING_PHASES = {
    "first_semi": {"start": "2026-05-12 20:00:00", "end": "2026-05-12 22:00:00", "countries": ["Aland", "Belgium", "Cyprus", "Denmark"]},
    "second_semi": {"start": "2026-05-14 20:00:00", "end": "2026-05-14 22:00:00", "countries": ["Estonia", "Finland", "Germany", "Greece"]},
    "grand_final": {"start": "2026-05-16 20:00:00", "end": "2026-05-16 23:00:00", "countries": ["Iceland", "Ireland", "Italy", "Norway"]},
}
...
def get_voting_status():
    ...
    for phase_id, phase_data in VOTING_PHASES.items():
        ...
        if now < start:
            ...
            remaining = end - now
            status = {"active": True, "status": f"До конца голосования осталось {str(remaining).split('.')[0]}", "countries": phase_data['countries']}
        else:
